...
// ======================
// Matrix Rain Canvas (sama seperti di Login)
// ======================
          ...
          <div className="relative bg-gray-900/90 backdrop-blur-sm border border-pink-500/40 rounded-xl shadow-2xl overflow-hidden shadow-pink-500/30">
            <div className="flex items-center gap-2 px-4 py-2 border-b border-pink-500/30 bg-gradient-to-r from-purple-900/50 to-pink-900/50">
              ...
              <div className="ml-2 text-xs text-pink-300/80 font-mono">
                matrix@identity:~ (15s simulation)
              </div>
            </div>
      ...
      <div className="flex items-center justify-center min-h-screen z-10">
        <div className="card w-full max-w-md bg-gray-900/80 backdrop-blur-md border border-pink-500/50 shadow-2xl shadow-pink-500/20">
          <div className="card-body space-y-4">
            ...
            <p className="text-purple-300 text-center font-mono">ACCESS GRANTED</p>

            <div className="bg-gray-800/80 p-3 rounded border border-purple-500/50 space-y-2">
            ...
            <div className="bg-gray-800/80 p-3 rounded border border-purple-500/50">
      ...
      <div className="flex items-center justify-center min-h-screen z-10">
        <div className="card w-full max-w-md bg-gray-900/80 backdrop-blur-md border border-pink-500/50 shadow-2xl shadow-pink-500/20">
          <div className="card-body">
            <h2 className="text-2xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent text-center mb-4">
              Identity Mesh-Protocol
            </h2>
            <button
              onClick={handleGenerate}
              className="btn bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 border-0 text-white w-full"
