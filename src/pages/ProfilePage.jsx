...
const ProfilePage = () => {
  ...
  return (
    <>
      ...
      {/* Padding top untuk navbar */}
      <div className="pt-16 min-h-screen bg-gray-900 relative">
        {/* Tombol kembali ke chat - absolute di dalam konten */}
        <button
          onClick={() => navigate('/')}
          className="absolute top-20 left-4 z-10 btn btn-circle btn-sm bg-purple-900/50 border-purple-500 text-purple-300 hover:bg-purple-800/70"
        ...
        <div className="modal-box bg-gray-900 border border-pink-500/40 shadow-xl shadow-pink-500/30 font-mono">
          ...
          <div className="p-4 text-sm space-y-3 max-h-96 overflow-y-auto text-purple-200/80">
            ...
            <ul className="list-disc list-inside space-y-1">
              <li>ID anonim (contoh: MESH-3FA92B) – dihasilkan acak, tidak bisa dilacak ke Anda.</li>
              <li>Hash dari secret key – kunci Anda tidak pernah disimpan mentah.</li>
              <li>Nama tampilan (display name: Anonymous).</li>
